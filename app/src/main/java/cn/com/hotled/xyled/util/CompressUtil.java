...
public class CompressUtil {
    ...
    public CompressUtil(Activity context, List<Program> programs, int screenWidth, int screenHeight,Handler handler) {
        mContext = context;
...
//        currentFrame=mProgramLengthList.get(whichProgram);
    ...
    public void startGenFile() {
        new Thread(new CompressUtil.GenFileThread()).start();
    }
