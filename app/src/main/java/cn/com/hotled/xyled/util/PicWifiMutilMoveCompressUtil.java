...
public class PicWifiMutilMoveCompressUtil {
    ...
    public PicWifiMutilMoveCompressUtil(Activity context, List<Program> programs, int screenWidth, int screenHeight, float frameTime, float stayTime) {
        mContext = context;
...
//            byte[] attrAddress = intToByteArray(attrStartAddress, 3);
    ...
    public void startGenFile() {
        new Thread(new PicWifiMutilMoveCompressUtil.GenFileThread()).start();
    }
