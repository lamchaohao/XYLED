            ...
            builder.title("连接到"+mWifiList.get(position).SSID)
                    ...
                    .onPositive(new MaterialDialog.SingleButtonCallback() {
                        ...
                        public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                            Toast.makeText(ConnectWifiActivity.this, "MaterialDialog.SingleButtonCallback()", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .negativeText("cancle")
    ...
    public void onCreateCustomToolBar(Toolbar toolbar) {
        ...
        ivEdit.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Toast.makeText(ConnectWifiActivity.this, "系统WIFI设置", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
