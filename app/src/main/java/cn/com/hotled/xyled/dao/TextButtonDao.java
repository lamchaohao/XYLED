...
/** 
 * DAO for table "TEXT_BUTTON".
*/
public class TextButtonDao extends AbstractDao<TextButton, Long> {

    public static final String TABLENAME = "TEXT_BUTTON";

    /**
     * Properties of entity TextButton.<br/>
    ...
    public TextButtonDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TEXT_BUTTON\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TEXT_BUTTON\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TextButton entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TextButton entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public TextButton readEntity(Cursor cursor, int offset) {
        TextButton entity = new TextButton( //
    ...
    @Override
    public void readEntity(Cursor cursor, TextButton entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TextButton entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TextButton entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TextButton entity) {
